...
<p>Avant de commencer, regardez la structure de votre dossier projet et répondez aux questions suivantes directemlent dans le code HTML.</p>
...
<p>Pourquoi le Dockerfile installe <code>pdo</code> et <code>pdo_mysql</code> ?</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>
...
<p>Pourquoi les deux premières lignes utilisent <code>SET NAMES utf8mb4</code> ?</p>
<fieldset>
    <legend>Aide</legend>
...
<p>Quand ce fichier est-il exécuté par MySQL ?</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>
...
<p>Écrivez la requête pour récupérer tous les élèves de la table (aidez-vous en cliuqant sur le bouton <code>SELECT *</code> ) :</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<p>Écrivez la requête pour récupérer uniquement les prénoms des élèves (aidez-vous en cliuqant sur <code>SELECT</code> ) :</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>
...
<p>Écrivez la requête pour insérer un nouvel élève : prénom "Lucas", nom "Petit" (aidez-vous en cliuqant sur <code>INSERT</code> ) :</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<h3>Exercice 12 — UPDATE</h3>

<p>Écrivez la requête pour changer le nom de l'élève "Lucas" en "Grand" (aidez-vous en cliuqant sur <code>UPDATE</code> ) :</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<h3>Exercice 13 — DELETE</h3>

<p>Écrivez la requête pour supprimer l'élève "Lucas Grand" (aidez-vous en cliuqant sur <code>DELETE</code> ) :</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>
...
<p>Vous allez maintenant communiquer avec MySQL en PHP en utilisant SQL. C'est à dire manipuler les données de la base sans passer par phpMyAdmin.</p>

<h3>Exercice 14 — Analyse du Code PHP existant</h3>

<p>Lire le code PHP de ce fichier de la ligne 28 à 39</p>

<p>Que fait le code de la ligne 28 à 32</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<p>Que fait le code de la ligne 34 à 35</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<p>Que fait le code de la ligne 37 à 39</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<p>Changer l'utilisateur ou le mot de passe de connexion à la base. Récatualisez le navigateur et notez vos observations.</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<h3>Exercice 15 — Récupérer plusieurs entrées</h3>

<p>En vous aidant du code PHP vu dans les questions précédentes, écrire le code PHP qui récupère toutes les propriétes de tous les élèves. Stocker cela dans la variable <code>$allStudents</code> et faire un <code>var_dump</code> de cette variable.</p>

<?php
// Coder ici en PHP...
?>

<p>Quel est le type de cette variable ?</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<p>Comment récupérer de <code>$allStudents</code> les données du premier élèves ?</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>

<p>Comment récupérer de <code>$allStudents</code> le prénom du premier élève ?</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>
<p>
    Le prénom est : 
    <?php
...
<h3>Exercice 16 — Récupérer une seule entrée</h3>

<p>Ecrire le code PHP qui récupère toutes les propriétes de l'élèves avec l'id 4. Stocker cela dans la variable <code>$Student</code> et faire un <code>var_dump</code> de cette variable.</p>
...
<p>Comment récupérer le nom de <code>$students</code> ?</p>
<div class="reponse" contenteditable="true">Répondez ici ...</div>
...
<h3>Exercice 17 — Effectuer une opération sur la base</h3>

<p>Ecrire le code PHP qui récupère le nombre total d'élèves de la table <code>student</code> (recherche Google) et qui le stocke dans une variable au nom explicite.</p>

<?php
// Coder ici en PHP...
?>
<p>
    Dans la table <code>student</code>, il y a : X
   <?php
    // Coder ici en PHP...
    ?>
     élèves
